...
public class BrokerJwtGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {

    private static final Logger log = LoggerFactory.getLogger(BrokerJwtGrantedAuthoritiesConverter.class);
    ...
    private Collection<String> getAuthorities(Jwt jwt) {
        ...
        if (log.isTraceEnabled()) {
            log.trace(String.valueOf(LogMessage.format("Looking for scopes in claim %s", claimName)));
        }
